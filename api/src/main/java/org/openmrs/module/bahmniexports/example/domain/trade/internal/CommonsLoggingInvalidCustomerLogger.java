...
import org.openmrs.module.bahmniexports.example.domain.trade.CustomerUpdate;
import org.openmrs.module.bahmniexports.example.domain.trade.InvalidCustomerLogger;
...
public class CommonsLoggingInvalidCustomerLogger implements InvalidCustomerLogger {
	...
	/* (non-Javadoc)
	 * @see org.openmrs.module.bahmniexports.example.domain.trade.InvalidCustomerLogger#log(org.openmrs.module.bahmniexports.example.domain.trade.CustomerUpdate)
	 */
	@Override
