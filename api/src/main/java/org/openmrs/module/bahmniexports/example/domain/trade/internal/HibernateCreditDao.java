...
public class HibernateCreditDao implements
	 ...
	 * (non-Javadoc)
	 *
	 * @see org.openmrs.module.bahmniexports.example.domain.trade.internal.CustomerCreditWriter#write(org.openmrs.module.bahmniexports.example.domain.CustomerCredit)
	 */
	@Override
